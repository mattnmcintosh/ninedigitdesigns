    ...
    const fetchWPContent = async () => {
      try {
        const response = await fetch(
          'https://public-api.wordpress.com/wp/v2/sites/9digitdesigns.wordpress.com/pages?slug=store',
          {
            headers: {
    ...
    <Box>
      ...
      <Grid container spacing={4} sx={{ mt: 1 }}>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Typography variant="h6" gutterBottom color="var(--text-heading, inherit)">Ready to Order?</Typography>
            <Typography variant="body2" paragraph sx={{ mb: 3 }}>
              If you know what size you want, you can purchase prints directly through the online shop.
            </Typography>
            <Button component={Link} to="/buy-online" variant="contained" color="primary" fullWidth size="large" disableElevation>
              Shopify Checkout
            </Button>
          </Paper>
        </Grid>
